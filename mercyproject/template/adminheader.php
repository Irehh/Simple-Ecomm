      ...
      <header class="navbar d-block navbar-sticky navbar-expand-lg navbar-light bg-light">
        <div class="container"><a class="navbar-brand d-none d-sm-block me-4 order-lg-1" href="index.html"><img src="img/logo-dark.png" width="142" alt="Cartzilla"></a><a class="navbar-brand d-sm-none me-2 order-lg-1" href="index.html"><img src="img/logo-icon.png" width="74" alt="Cartzilla"></a>
          <div class="navbar-toolbar d-flex align-items-center order-lg-3">
           ...
           <a class="btn btn-sm btn-accent rounded-1 ms-lg-4 ms-3" href="./addproduct.php">ADD</a>
          </div>
          <div class="collapse navbar-collapse me-auto order-lg-2" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item"><a class="nav-link" href="./productcatalog.php">Shoes</a></li>
              <li class="nav-item"><a class="nav-link" href="./productcatalog.php">Bags</a></li>
              <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">Catalog</a>
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="./productcatalog.php">Watches</a></li>
                  <li><a class="dropdown-item" href="./productcatalog.php">Others</a></li>
                </ul>
              </li>
      ...
      <div class="page-title-overlap bg-accent pt-4">
        <div class="container d-flex flex-wrap flex-sm-nowrap justify-content-center justify-content-sm-between align-items-center mb-2 pt-2">
          <div class="d-flex align-items-center">
            <div class="img-thumbnail rounded-circle position-relative flex-shrink-0" style="width: 6.375rem;"><img class="rounded-circle" src="img\toonme.jpg" alt="mercy @admin picture"></div>
            <div class="ps-3">
              <h3 class="h5 mb-2 text-light">@Mercy</h3><span class="d-block text-light fs-sm opacity-60">Joined July 2021</span>
            </div>
          </div>
          <div class="my-sm-0 my-3 text-sm-end pt-1">
            <div class="d-flex align-items-center text-nowrap fs-sm">
              <div class="mb-2 me-sm-3 me-2 text-muted"><span class='fw-medium text-light'>45464</span> <span class='text-white opacity-70'>Page Views</span></div>
