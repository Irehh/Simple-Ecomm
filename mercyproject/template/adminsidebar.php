              ...
              <div class="h-100 border-end mb-2">
                <div class="d-lg-block collapse" id="account-menu">
                  <ul class="list-unstyled mb-0">
                    <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="./addproduct.php"><i class="ci-settings opacity-60 me-2"></i>Add Product</a></li>
                    <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="./admin.php"><i class="ci-bell opacity-60 me-2"></i>Listed Product</a></li>
